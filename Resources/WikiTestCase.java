...
public class WikiTestCase {
  ...
  public void testWikiTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Portal de la comunidad'])[2]/following::a[1]")).click();
    driver.findElement(By.linkText("Cambios recientes")).click();
    driver.findElement(By.linkText("Páginas nuevas")).click();
